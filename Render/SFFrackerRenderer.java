...
public class SFFrackerRenderer extends TileEntityRenderBase {
	...
	private void renderModel(TileFrackingPressurizer te) {
		...
		//model.drawChassis();
		GL11.glPushMatrix();
		GL11.glTranslated(0, -te.thumperPosition1, 0);
		//model.drawThumper1();
		GL11.glTranslated(0, te.thumperPosition1-te.thumperPosition2, 0);
		//model.drawThumper2();
		GL11.glTranslated(0, te.thumperPosition2-te.thumperPosition3, 0);
		//model.drawThumper3();
		GL11.glTranslated(0, te.thumperPosition3, 0);
		GL11.glPopMatrix();
		GL11.glPushAttrib(GL11.GL_ALL_ATTRIB_BITS);
		ReikaRenderHelper.disableLighting();
		ReikaRenderHelper.disableEntityLighting();
