...
public class BiomePinkForest extends BiomeGenBase implements DyeTreeBlocker, NonconvertibleBiome, WinterBiomeStrengthControl, CustomMapColorBiome {
	...
	public BiomePinkForest(int id) {
		...
		spawnableMonsterList.add(new BiomeGenBase.SpawnListEntry(EntityCreeper.class, 25, 1, 3));
		...
		//spawnableMonsterList.add(new BiomeGenBase.SpawnListEntry(SpawnReducingPlaceholder.class, 50, 1, 1));
		spawnableMonsterList.add(new BiomeGenBase.SpawnListEntry(EntitySpider.class, 30, 1, 3)); //large stinger stand-in
		spawnableMonsterList.add(new BiomeGenBase.SpawnListEntry(EntityCaveSpider.class, 25, 2, 4)); //basic (small) stinger stand-in
